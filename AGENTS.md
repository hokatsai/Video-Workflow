...
└── tools/{README.md, gemini-run.ps1, ...}
```
...
- **Helper scripts**：儲存在根目錄 `tools/`，集中可重用的自動化腳本（如 Gemini 包裝器）。
...
## 輸出
- **主要輸出**：說明路徑與內容（例：`03-outputs/<tool-name>/...`）
- **稽核需求**：若需額外驗證請明載。

## 輸入 / 儲存位置
- 輸入來源：`02-inputs/...`
- 儲存位置：`03-outputs/<tool-name>/...`

## 限制與注意事項
- 安全/授權限制等。

## 疑難排解
- 若遇錯誤，請參照 `01-system/docs/agents/TROUBLESHOOTING.md`。
...
## ϵ�y�ܘ���ģʽ (Systems Architect Mode)
- **�|�l�l��**: ��ʹ����Ո�󌦹��������M���}�P�����������Q�����Ԇ��}�r�����磺�������}�Pһ�¡����������������������ҳ����}�K��Q������
- **������D**: ��Ó�μ���ָ����У��Լܘ�����ҕ�Ƿ������OӋ�K�̻������ѡ���Ч���Ԅӻ���Q������
- **���в��E**:
  1. **�}�̷��� (Review & Analyze)**: ȫ��zҕ��ǰ�Ĺ��������R�e���еġ��h��Ħ���������W·Ħ�����c������Ħ������
  2. **����ԭ��λ (Root Cause Analysis)**: �ҳ������������L��ʧ���ĸ���ԭ������h��δ֪����ه�ȱʧ�����͆��w�����ȡ�
  3. **����������� (Propose New Architecture)**: �OӋ�µġ�ģ�M���Ĺ�����������Playbook���������h���A�z���΄ղ�֡��K��̎�����Y���R���Ȳ��ԡ�
  4. **�̻������� (Codify Workflow)**:
